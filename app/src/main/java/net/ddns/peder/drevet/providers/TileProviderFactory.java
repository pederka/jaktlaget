...
public class TileProviderFactory {
    ...
    public static WMSTileProvider getOsgeoWmsTileProvider() {
        final String WMS = "http://wms.geonorge.no/skwms1/wms.topo2?request=GetMap&version=1.3.0&layers=topo2_WMS&bbox=%f,%f,%f,%f&width=256&height=256&crs=EPSG:4326&format=image/jpeg";
        ...
        WMSTileProvider tileProvider = new WMSTileProvider(256, 256) {
            ...
            public synchronized URL getTileUrl(int x, int y, int zoom) {
                ...
                String s = String.format(Locale.US, WMS, bbox[MINY], bbox[MINX], bbox[MAXY], bbox[MAXX]);
                Log.d("WMSDEMO", s);
                URL url = null;
                try {
                    url = new URL(s);
